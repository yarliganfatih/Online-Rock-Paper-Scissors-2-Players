...
<div id="console"><center><h2>
	<div id="start">
		<div id="rock" class="button1" onclick="rock()"><img src="arock.png" alt="rock" height="256"><br><br>TAŞ</div>
		<div id="paper" class="button1" onclick="paper()"><img src="apaper.png" alt="paper" height="256"><br><br>KAĞIT</div>
		<div id="makas" class="button1" onclick="makas()"><img src="amakas.png" alt="makas" height="256"><br><br>MAKAS</div>
	</div><br>
	<div id="animation" style="display:none;width:100%;">
		<div id="p1select" class="button3"><img id="p1s" src="brock.png" alt="p1" height="256" width="256"><br><br>PLAYER 1</div>
		<div id="p2select" class="button3"><img id="p2s" src="brock.png" alt="p1" height="256" width="256"><br><br>PLAYER 2</div>
	...
	<div id="beplayer">
		...
		<div id="replay" class="button2" onclick="replay();" style="color:black;">TEKRAR OYNA</div>
...
function rock(){
	...
	window.document.getElementById("rock").style.border = "10px dashed #000000";
	window.document.getElementById("paper").style.border = "0px dashed #000000";
	window.document.getElementById("makas").style.border = "0px dashed #000000";
	s=2;
	if(wanted=="wait"){
...
function paper(){
	...
	window.document.getElementById("rock").style.border = "0px dashed #000000";
	window.document.getElementById("paper").style.border = "10px dashed #000000";
	window.document.getElementById("makas").style.border = "0px dashed #000000";
	s=2;
	if(wanted=="wait"){
		show("wantgo.php","#div6");
...
function makas(){
	...
	window.document.getElementById("rock").style.border = "0px dashed #000000";
	window.document.getElementById("paper").style.border = "0px dashed #000000";
	window.document.getElementById("makas").style.border = "10px dashed #000000";
	s=2;
	if(wanted=="wait"){
		show("wantgo.php","#div6");
	}else{
...
function game(){
	...
	window.document.getElementById("replay").style.color="black";
	if(wanted=="go"){
		//animation();
...
function win(){
	...
	window.document.getElementById('p1s').src="b" + p1 + ".png";
	window.document.getElementById('p2s').src="b" + p2 + ".png";
	...
	if(winn == true){
		...
		window.document.getElementById(a).style.border = "10px dashed #000000";
	}else{
...
function reset(){
	...
	stopped=false;
	waiter = "";
	window.document.getElementById('p1s').src="brock.png";
	window.document.getElementById('p2s').src="brock.png";
	window.document.getElementById("p1s").style.border = "0px dashed #000000";
	window.document.getElementById("p2s").style.border = "0px dashed #000000";
	window.document.getElementById("rock").style.border = "0px dashed #000000";
	window.document.getElementById("paper").style.border = "0px dashed #000000";
	window.document.getElementById("makas").style.border = "0px dashed #000000";
}
